...
@interface summaryMatress : UIViewController<MFMailComposeViewControllerDelegate>
...
@property (strong, nonatomic) IBOutlet UILabel *Elastic;
...
@property (strong, nonatomic) NSString *ElasticStringF;
...
@property (nonatomic, retain) IBOutlet UILabel *en;
