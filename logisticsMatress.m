...
@interface logisticsMatress ()

@end

@implementation logisticsMatress
int variabla;
...
- (void)viewDidLoad {
    ...
    _ElasticLabel2.text = _ElasticStringLog;
    ...
    //11
    pickerArray11 = [[NSMutableArray alloc] initWithObjects:@"Yes", @"No", nil];
    //
    //
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    commentspageMatress *CMVC = [segue
                               destinationViewController];
    CMVC.custStringCom  = _custNameLabel2.text;
    CMVC.boundStringCom = _boundLabel2.text;
    CMVC.dateStringCom = _dateLabel2.text;
    CMVC.farbicStringCom = _farbicLabel2.text;
    CMVC.fibreStringCom = _fibreLabel2.text;
    CMVC.sasshStringCom = _sasshlabel1.text;
    CMVC.innaStringCom = _innaLabel1.text;
    CMVC.packedStringCom = _packedLabel1.text;
    CMVC.palletStringCom = _palletLabel1.text;
    CMVC.outerStringCom = _outerLabel1.text;
    CMVC.sizeStringCom = _sizeLabel2.text;
    CMVC.quantityStringCom = _quantityLabel2.text;
    CMVC.customerStringCom = textField9.text;
    CMVC.devileryStringCom = textField10.text;
    CMVC.weeksStringCom = weekField.text;
    CMVC.ElasticStringCom = _ElasticLabel2.text;
    CMVC.t1StringCom =_t1.text;
    CMVC.t2StringCom=_t2.text;
    CMVC.t3StringCom=_t3.text;
    CMVC.t4StringCom=_t4.text;
    CMVC.t5StringCom=_t5.text;
    CMVC.t6StringCom=_t6.text;
    CMVC.t7StringCom=_t7.text;
    CMVC.t8StringCom=_t8.text;
    CMVC.t9StringCom=_t9.text;
    CMVC.t10StringCom=_t10.text;
    CMVC.t11StringCom=_t11.text;
    CMVC.t12StringCom=_t12.text;
    CMVC.t13StringCom=_t13.text;
    CMVC.t14StringCom=_t14.text;
    CMVC.t15StringCom=_t15.text;
    CMVC.t16StringCom=_t16.text;
    CMVC.t17StringCom=_t17.text;
    CMVC.t18StringCom=_t18.text;
    CMVC.t19StringCom=_t19.text;
    CMVC.t20StringCom=_t20.text;
    CMVC.t21StringCom=_t21.text;
    CMVC.t22StringCom=_t22.text;
    CMVC.t23StringCom=_t23.text;
    CMVC.t24StringCom=_t24.text;
    CMVC.t25StringCom=_t25.text;
    CMVC.t26StringCom=_t26.text;
    CMVC.t27StringCom=_t27.text;
    CMVC.t28StringCom=_t28.text;
    CMVC.t29StringCom=_t29.text;
    CMVC.t30StringCom=_t30.text;
    CMVC.A1StringCom=_A1.text;
    CMVC.A2StringCom=_A2.text;
    CMVC.A3StringCom=_A3.text;
    CMVC.A4StringCom=_A4.text;
    CMVC.A5StringCom=_A5.text;
    CMVC.ALLStringCom=_ALL.text;
    CMVC.MISStringCom=_MIS.text;
}
