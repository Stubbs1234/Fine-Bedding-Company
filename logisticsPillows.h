...
@interface logisticsPillows : UIViewController<UIPickerViewDelegate, UIPickerViewDataSource> {
...
@property (strong, nonatomic) IBOutlet UILabel *ticksLabel2;
...
@property (strong, nonatomic) IBOutlet UILabel *typeLabel2;
...
@property (strong, nonatomic) NSString *ticksStringLog;
...
@property (strong, nonatomic) NSString *typeStringLog;
