...
@interface summaryMatress ()

@end

@implementation summaryMatress
@synthesize view1;
...
- (IBAction)save:(id)sender {
    ...
    NSString *topper=[docPath stringByAppendingPathComponent:self.custNameLabel4.text];//@"topper.csv"
    ...
    [picker addAttachmentData:[NSData dataWithContentsOfFile:topper]
                     mimeType:@"text/csv"
                     fileName:self.custNameLabel4.text];//@"topper.csv"
...
-(void)mailComposeController:(MFMailComposeViewController*)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError*)error
{
    ...
    //NSString *pageLink = @"http://www.finebedding.co.uk";
@end
