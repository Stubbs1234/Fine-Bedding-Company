...
-(IBAction)backButton:(id)sender;
{
    ...
    UIPageViewController* ViewController = [Main instantiateViewControllerWithIdentifier:@"HOMEPAGE"];
...
{
    SizeDuvet *SIDVC = [segue
                        destinationViewController];
        
        SIDVC.custStringSize = custField.text;
        SIDVC.dateStringSize = dateField.text;
        SIDVC.fibreStringSize = textField3.text;
        SIDVC.boundStringSize = textField4.text;
}
