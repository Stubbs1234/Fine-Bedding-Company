...
@interface SIZETOPPER : UIViewController <UIPickerViewDelegate, UIPickerViewDataSource> {
...
@property (strong, nonatomic) NSString *sizeStringSize;
@property(nonatomic, retain) NSString *ElasticStringSize;
