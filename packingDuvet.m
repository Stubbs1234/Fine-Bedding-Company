...
@interface packingDuvet ()

@end

@implementation packingDuvet
int variabla;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    logisticsDuvet *LDVC = [segue
                          destinationViewController];
    LDVC.custStringLog = _custNameLabel1.text;
    LDVC.dateStringLog = _dateLabel1.text;
    LDVC.farbicStringLog = _farbicLabel1.text;
    LDVC.fibreStringLog = _fibreLabel1.text;
    LDVC.boundStringLog = _boundLabel1.text;
    LDVC.quantityStringLog = _quantityLabel1.text;
    LDVC.sizeStringLog = _sizeLabel1.text;
    LDVC.sasshStringLog = textField4.text;
    LDVC.packedStringLog = textField5.text;
    LDVC.innaStringLog = textField6.text;
    LDVC.outerStringLog = textField8.text;
    LDVC.palletStringLog = textField10.text;
    LDVC.t1StringLog =_t1.text;
    LDVC.t2StringLog=_t2.text;
    LDVC.t3StringLog=_t3.text;
    LDVC.t4StringLog=_t4.text;
    LDVC.t5StringLog=_t5.text;
    LDVC.t6StringLog=_t6.text;
    LDVC.t7StringLog=_t7.text;
    LDVC.t8StringLog=_t8.text;
    LDVC.t9StringLog=_t9.text;
    LDVC.t10StringLog=_t10.text;
    LDVC.t11StringLog=_t11.text;
    LDVC.t12StringLog=_t12.text;
    LDVC.t13StringLog=_t13.text;
    LDVC.t14StringLog=_t14.text;
    LDVC.t15StringLog=_t15.text;
    LDVC.t16StringLog=_t16.text;
    LDVC.t17StringLog=_t17.text;
    LDVC.t18StringLog=_t18.text;
    LDVC.t19StringLog=_t19.text;
    LDVC.t20StringLog=_t20.text;
    LDVC.t21StringLog=_t21.text;
    LDVC.t22StringLog=_t22.text;
    LDVC.t23StringLog=_t23.text;
    LDVC.t24StringLog=_t24.text;
    LDVC.t25StringLog=_t25.text;
    LDVC.t26StringLog=_t26.text;
    LDVC.t27StringLog=_t27.text;
    LDVC.t28StringLog=_t28.text;
    LDVC.t29StringLog=_t29.text;
    LDVC.t30StringLog=_t30.text;
    LDVC.A1StringLog=_A1.text;
    LDVC.A2StringLog=_A2.text;
    LDVC.A3StringLog=_A3.text;
    LDVC.A4StringLog=_A4.text;
    LDVC.A5StringLog=_A5.text;
    LDVC.ALLStringLog=_ALL.text;
    LDVC.MISStringLog=_MIS.text;
}
