...
@interface summaryDuvet : UIViewController<MFMailComposeViewControllerDelegate>
...
@property (strong, nonatomic) IBOutlet UILabel *farbicLabel4;
...
@property (strong, nonatomic) IBOutlet UILabel *sizeLabel4;
...
@property (strong, nonatomic) NSString *farbicStringF;
...
@property (strong, nonatomic) NSString *sizeStringF;
