...
@interface packingPillows : UIViewController<UIPickerViewDelegate, UIPickerViewDataSource> {
...
@property (strong, nonatomic) IBOutlet UILabel *ticksLabel1;
...
@property (strong, nonatomic) IBOutlet UILabel *typeLabel1;
@property (strong, nonatomic) NSString *custStringPack;
@property (strong, nonatomic) NSString *dateStringPack;
@property (strong, nonatomic) NSString *ticksStringPack;
...
@property (strong, nonatomic) NSString *typeStringPack;
...
@property(nonatomic,retain) IBOutlet UITextField *textField13;
